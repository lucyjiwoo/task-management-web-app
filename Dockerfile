# Access instance using `docker exec -it finalexam-container_flask-app bash`
...
CMD service mysql start && exec gunicorn --bind :$PORT --workers 1 --worker-class eventlet --threads 8 app:app
